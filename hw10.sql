...
-- II. Part b
	...
	--i.
		SELECT DISTINCT DEPARTMENT.Dname, PROJECT.Pname, PROJECT.Plocation FROM DEPARTMENT
	...
	--ii.
		SELECT DISTINCT DEPARTMENT.Dnumber, DEPARTMENT.Dname FROM DEPARTMENT
		JOIN PROJECT ON PROJECT.Dnum = DEPARTMENT.Dnumber
		JOIN DEPT_LOCATIONS ON DEPT_LOCATIONS.Dnumber = DEPARTMENT.Dnumber
		WHERE DEPT_LOCATIONS.Dlocation = PROJECT.Plocation AND PROJECT.Dnum >= 2;
	...
	--iii.
		...
		DELETE FROM DEPT_LOCATIONS WHERE DEPT_LOCATIONS.Dlocation = 'Houston' AND DEPT_LOCATIONS.Dnumber = 5;
...
-- III. Part c
	...
	-- i.
		INSERT INTO DEPARTMENT DEPARTMENT.Dnumber VALUES 6;
		ROLLBACK;
		SELECT * FROM EMPLOYEE 
		JOIN DEPARTMENT ON DEPARTMENT.Dnumber = EMPLOYEE.Dno 
		WHERE DEPARTMENT.Dnumber = 2;


	-- ii.
		SELECT Salary FROM EMPLOYEE 
		JOIN DEPENDENT on EMPLOYEE.Ssn = DEPENDENT.Essn AND DEPENDENT.Essn >= 2; 

		
	-- iii.
		SELECT Hours FROM WORKS_ON 
		WHERE WORKS_ON.Essn = 987654321;
